...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     */
    @Override
    public R getPage(Integer currentPage, Integer pageSize, User user) throws RuntimeException {
     ...
     * @return
     */
    public R update(User user) throws RuntimeException {
     ...
     */
    @Override
    public R selectUserCount() throws RuntimeException {
        //查找男用户数量
     ...
     */
    @Override
    public R login(User user, HttpServletRequest request) throws RuntimeException {
        QueryWrapper<User> query = Wrappers.query();
     ...
     */
    @Override
    public R getUser() throws RuntimeException {
        //从本地线程获取登录用户的id
...
//                SMSUtils.sendMessage("小松音乐", "", phone, code);
