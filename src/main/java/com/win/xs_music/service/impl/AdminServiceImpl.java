...
public class AdminServiceImpl extends ServiceImpl<AdminMapper, Admin> implements AdminService {
     ...
     */
    @Override
    public R adminMgrPage(Admin admin, Integer currentPage, Integer pageSize) throws RuntimeException {
     ...
     */
    @Override
    public R login(Admin admin, HttpServletRequest request) throws RuntimeException {
        LambdaQueryWrapper<Admin> wrapper = new LambdaQueryWrapper<>();
